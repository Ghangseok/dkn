...
<body>
    ...
    <div class="address-bar">9876 Yonge St. | Toronto, CA M2N 6H9 | 647.456.7890</div>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">DKN Car Service Centre</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="service.php">Making appointment</a>
                    </li>
                    <li>
