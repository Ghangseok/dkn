        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="img/car1_img.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/car2_img.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/car3_img.jpg" alt="">
                            </div>
                        </div>
                    ...
                    <h1 class="brand-name">DKN Car Service Centre</h1>
                    <hr class="tagline-divider">
                    <h2>
                        <small>By
                            <strong>Karamjeet</strong>
                        </small>
                    </h2>
                </div>
            </div>
